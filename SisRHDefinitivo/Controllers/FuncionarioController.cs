...
namespace SisRHDefinitivo.Mvc.Adm.Controllers
{
    ...
    public class FuncionarioController : Controller
    {
        ...
        public async Task<PartialViewResult> Search(
            ViewModels.Funcionario.IndexViewModel indexViewModel, int idFuncionario)
        {
            var funcionarioView = new ConsultarFuncionariosView
            {
                id_func = Convert.ToInt32(indexViewModel.DadosFuncionario.id_func),
            ...
            var funcionarioList = await _funcionarioRepository.ListarDados();
           ...
           ViewModels.Funcionario.EditViewModel editViewModel)
        {
            ...
            var resultado = await _funcionarioRepository.UpdateAsync(funcionario);
            return Json(resultado);
        }
